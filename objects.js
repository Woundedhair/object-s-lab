...
function personName(firstNameProp) {
  const person = {
    firstName: 'Sally',
    lastName: 'Smith',
    age: 29,
...
const locationProp = personLocation();
...
function updateProfile(profile, property, value) {
    ...
    userProfile.email = 'blah@yahoo.com' 
